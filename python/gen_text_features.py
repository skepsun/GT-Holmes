...
if __name__ == '__main__':
	...
	for line in sys.stdin:
		...
		print >> sys.stderr, '[INFO] No. %d, Incident Id: %s, Labels: %s' % (i, incident_id, crime_code_1)
		try:
			text_analysor.set_text(remarks, crime_code_1.split('#'))
		except Exception, e:
	...
	text_analysor.save_variables('tmp/woodie.new_data/text_analysor/2017_3_10')
	# text_analysor.load_variables('tmp/woodie.new_data/test_saver')
	# print >> sys.stderr, text_analysor.dt_matrix
	# print >> sys.stderr, text_analysor.labels
